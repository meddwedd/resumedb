...
public abstract class AbstractStorageTest {
    ...
    public void setUp() {
        resumes = new ArrayList<Resume>() {
            {
                ...
                add(Resume.of("Ксения Ермолова", "Ярославль", "http://yahoo.com"));
            }
        };
        ...
        resume0.addSection(SectionType.POSITION, TextSection.from("Java разработчик", "начинающий"));
...
/*        //Resume at index 3
        ...
        resume3.addSection(SectionType.POSITION, TextSection.from(""));
